                                    ...
                                    <div class="white_box_tittle list_header">
                                        ...
                                        <div class="box_right d-flex lms_block">
                                            ...
                                            <div class="add_button ms-2">
                                                <a href="{{ route('tambahkata') }}" class="btn_1">Tambah
                                                    Komentar</a>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <table class="table lms_table_active ">
                                            ...
                                            <tbody>
                                                ...
                                                @foreach ($katamereka as $komen)
                                                    ...
                                                    <tr>
                                                        <th scope="row">{{ $a }}</th>
                                                        <td>{{ $komen->testi_name }} </td>
                                                        <td>{{ $komen->testi_desc }}</td>
                                                        <td> <img src="{{ asset('testiImg/' . $komen->testi_img) }}"
                                                                alt="image" height="40px" width="40px"
                                                                style="border-radius: 100%"></td>
                                                        <td>
                                                            <a href="{{ route('editkata', [$komen->id]) }}"
                                                                class="edit"><i class="fa fa-1x fa-edit"></i></a>
                                                            <a href="{{ route('deletekata', [$komen->id]) }}"
