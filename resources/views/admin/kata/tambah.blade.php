                    ...
                    <div class="col-lg-12">
                        <div class="white_card card_height_100 mb_30">
                            ...
                            <div class="white_card_body">
                                <div class="card-body">
                                    <form action=" {{ route('storekata') }} " method="POST" enctype="multipart/form-data">
                                        @csrf
                                        {{-- @if ($errors->any())
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <textarea class="form-control" name="testi_desc" id="testi_desc" rows="3" required></textarea>
                                        </div>
                                        <div class="mb-3">
                                            <label for="formFile" class="form-label">Gambar</label>
                                            <input class="form-control" name="testi_img" type="file"
