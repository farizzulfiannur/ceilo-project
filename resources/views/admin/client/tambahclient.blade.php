                                ...
                                <div class="card-body">
                                    <form action=" {{ route('storeclient') }} " method="POST"
                                        ...
                                        <div class="form-group mb-3">
                                            ...
                                            <input type="text" name="client_name" id="product_link"
                                                class="form-control" required>
                                        </div>
                                        <div class="mb-3">
                                            <label for="formFile" class="form-label">Logo Client</label>
                                            <input class="form-control" name="client_img" type="file"
