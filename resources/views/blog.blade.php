    ...
    <main id="main">
        ...
        <section id="about" class="features">
            ...
            <div class="container" data-aos="fade-up">
                <div class="row res">
                    <div class="col-lg-12 mt-5 mb-3 ms-3">
                        <h1> Blog </h1>
                    </div>
                    @foreach ($blog as $blogs)
                    <div class="col-lg-4 col-md-6 col-xs-12 mb-4">
                        <a href="{{ route('showBlog', [$blogs->id]) }}">
                            <div class="card mb-3" style="border: none;">
                                <div class="card-body">
                                    <img src="{{ asset('imageBlog/' .  $blogs->imageBlog ) }}" alt=""
                                        width="318px" style="border-radius:14px">
                                    <p class="text-center" style="font-size: 25px; font-weight: 600; color: black">{{ $blogs->titleBlog }} </p>
                                </div>
                            </div>
                        </a>
                    </div>
