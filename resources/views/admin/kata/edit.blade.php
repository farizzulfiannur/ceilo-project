                    ...
                    <div class="col-lg-12">
                        <div class="white_card card_height_100 mb_30">
                            <div class="white_card_header">
                                <div class="box_header m-0">
                                    <div class="main-title">
                                        <h2 class="m-0">Tambah Kata Mereka</h2>
                                    </div>
                            ...
                            <div class="white_card_body">
                                <div class="card-body">
                                    <form action=" {{ route('updatekata', [$katamereka->id]) }} " method="post"
                                        ...
                                        <div class="form-group mb-3">
                                            ...
                                            <input type="text" name="testi_name" id="testi_name"
                                                value="{{ $katamereka->testi_name }}" class="form-control" required>
                                        </div>
                                        <div class="mb-3">
                                            <label for="dest_desc" class="form-label">Deskripsi</label>
                                            <textarea class="form-control" name="testi_desc" id="testi_desc" rows="3" required> {{ $katamereka->testi_desc }} </textarea>
                                        </div>
                                        <div class="mb-3">
                                            <p style="color: black;" for=""> Image : </p>
                                            <img src="{{ asset('/testiImg/' . $katamereka->testi_img) }}"
                                                class="img-responsive mt-2"
                                                style="max-height: 100px; max-width: 100px;" alt=""
                                                srcset="">
                                            <input type="file" id="input-file-now-custom-3"
                                                class="form-control m-4" name="testi_img" required>
                                        </div>
                                        {{-- <div class="mb-3"> 
                                            <img src="{{ asset('/testiImg/' . $katamereka->testi_img) }}"
                                            class="img-responsive" style="max-height: 100px; max-width: 100px;"
                                            alt="">
                                            <input class="form-control mt-3" name="testi_img" type="file"
