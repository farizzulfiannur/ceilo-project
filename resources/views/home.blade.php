          ...
          <div class="owl-service-item owl-carousel">
            <div class="item">
              <div class="service-item">
                <div class="icon">
                  <img src="assets/images1/cactus_sukulen.png" width="80px" height="80px" alt="">
                </div>
                <h4>Kaktus Sukulen Artificial</h4>
                <p>Rp. 27.400 </p>
                <div class="main-button-gradient">
                  <div class="scroll-to-section ops"><a class="mt-4" style="padding: 6px 6px;" href="#">Details</a>
                  </div>
                </div>
              </div>
            </div>
            <div class="item">
              <div class="service-item">
                <div class="icon">
                  <img src="assets/images1/bunga_matahari.png" width="80px" height="80px" alt="">
                </div>
            ...
            <div class="item">
              <div class="service-item">
                <div class="icon">
                  <img src="assets/images1/bunga_krisan.png" width="80px" height="80px" alt="">
                </div>
            ...
            <div class="item">
              <div class="service-item">
                <div class="icon">
                  <img src="assets/images1/bunga_tulip.png" width="80px" height="80px" alt="">
                </div>
      ...
      <div class="row">
        <div class="col-lg-7">
          <div class="videoWrapper">
            ...
            <iframe src="//www.youtube.com/embed/DjlOulLbrQ8" frameborder="0" allowfullscreen class="video"></iframe>
        ...
        <div class="col-lg-12">
          <ul class="social-icons">
            ...
            <li><a href="#"> <img src="assets/images1/whatsapp-logo.svg" style="padding: 7px; padding-top: 2px;"
                  alt="Whatsapp"></a></li>
            ...
            <li><a href="https://www.lazada.co.id/shop/ceilo-project"> <img src="assets/images1/lazada.svg"
