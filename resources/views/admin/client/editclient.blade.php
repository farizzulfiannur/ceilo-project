                                ...
                                <div class="box_header m-0">
                                    ...
                                    <div class="col-6 d-flex justify-content-end">
                                        <a class="btn-close btn-outline-danger" aria-label="close"
                                            href="{{ route('adminclient') }}" role="button"></a>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="card-body">
                                    <form action=" {{ route('updateclient', [$client->id]) }} " method="post"
                                        ...
                                        <div class="form-group mb-3">
                                            ...
                                            <input type="text" name="client_name" id="testi_name"
                                                value="{{ $client->client_name }}" class="form-control" required>
                                        </div>
                                        <div class="mb-3">
                                            <p style="color: black;" for=""> Image : </p>
                                            <img src="{{ asset('/clientImg/' . $client->client_img) }}"
                                                class="img-responsive mt-2"
                                                style="max-height: 100px; max-width: 100px;" alt=""
                                                srcset="">
                                            <input type="file" id="input-file-now-custom-3"
                                                class="form-control m-4" name="client_img" required>
                                        </div>
